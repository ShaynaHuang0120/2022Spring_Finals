...
# general purpose: merge_data, process_data, lap_data_process, pit_stop_group
...
# hypothesis 4: rank_df_plt, barchart_lapspeed
def rank_df_plt(df: pd.DataFrame, threshold=0.05):
    ...
    """
    print(
        'H0: There is no significant difference in standard deviation of time spent on laps between drivers with high '
        'ranking and drivers with low ranking.')
    rank_list = []
    gap_list = []
